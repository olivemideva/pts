...
<html lang="en">
  ...
  <div class="one">
  <a href="<?= base_url('/'); ?>"><span class="las la-arrow-circle-left" id="back"></span></a>

<div class="form-box">
    <img src="<?php echo base_url('assets/images/parole_icon.png'); ?>">

    <!-- <h1>Login</h1> -->

    <form id="login" class="input-group" method="POST" action="<?= base_url('login_parole');?>">
    <?= csrf_field(); ?>
