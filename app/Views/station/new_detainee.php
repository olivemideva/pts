...
<?php include(APPPATH.'Views\admin\templates\sidebar.php'); ?>
   ...
   <form class="add-form" method="post" action="<?= base_url('add_detainee'); ?>">
      ...
      <div class="horizontal-group">
        ...
        <div class="horizontal-group">
          <div class="form-group left">
            ...
            <input type="date" id="date" class="form-input" placeholder="Enter arrest date" name="arrested_on"/>
            <span class ="text-danger"><?= isset($validation) ? display_error($validation, 'arrested_on') : '' ?></span>
          </div>
          <div class="form-group right">
            <label for="time" class="label-title">Detainee's Arrest time *</label>
            <input type="time" class="form-input" id="time" placeholder="enter arrest time" name="arrested_time">
            <span class ="text-danger"><?= isset($validation) ? display_error($validation, 'arrested_time') : '' ?></span>
          </div>
        </div>
        <div class="horizontal-group">
          <div class="form-group left">
            <label for="firstname" class="label-title">Detainee's Arrested for *</label>
            <input type="text" id="cause" class="form-input" placeholder="Enter arrest cause" name="arrested_of" />
            <span class ="text-danger"><?= isset($validation) ? display_error($validation, 'arrested_of') : '' ?></span>
          </div>
          <div class="form-group right">
            <label for="bothnames" class="label-title">Detainee's Arrested by *</label>
            <input type="text" id="bothnames" class="form-input" placeholder="Enter arrest officer name" name="arrested_by"/>
            <span class ="text-danger"><?= isset($validation) ? display_error($validation, 'arrested_by') : '' ?></span>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-input" rows="3" cols="50" style="height:auto" name="posessions"></textarea>
          <span class ="text-danger"><?= isset($validation) ? display_error($validation, 'posessions') : '' ?></span>
        </div>
